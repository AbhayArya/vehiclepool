...
<title>Request Accepted | VehiclePool.Com</title>
	...
	%>
		...
		<form action="#" method="get">
			<div class="form-group">
				<h1>You have successfully requested for a ride.</h1>
				<hr>
				<h4>
					<a href="options.jsp">Click Here to check status and continue POOLING!</a>
				</h4>
			</div>
		</form>
	</div>
