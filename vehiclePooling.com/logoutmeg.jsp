...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
		<div class="container">
			<a class="navbar-brand" href="index.jsp">VehiclePool.Com</a>
	...
	<div class="signup-form">
		<form action="#" method="get">
			<div class="form-group">
				<h1>Thank you! You have been successfully logged out.</h1>
				<hr>
				<h4>
					<a href="index.jsp">Click Here to continue POOLING!</a>
				</h4>
			</div>
		</form>
	</div>
